...
import com.neverpile.fusion.configuration.ModelMapperConfiguration;
...
@ContextConfiguration(classes = {
    JacksonAutoConfiguration.class, JacksonConfiguration.class, ModelMapperConfiguration.class,
